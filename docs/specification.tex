...
The primitive values in Blueprinter are strings and numbers. The combining forms are Furniture, Rooms, and Levels. 
...
\\\\
Because primitive values in Blueprinter follow a similar form and usage as other programming languages, I'll discuss combining forms, variables, and type definitions in this section.
...
Within a type definition can be anything included in a normal Blueprinter program with the exception that a type definition currently cannot be defined inside another type definition (this might change in the future).
